...
if ( !gtk_builder_add_from_file (builder, "project1.xml", &error)) { 
...
data->button = GTK_WIDGET(gtk_builder_get_object (builder, "button1")); 
data->label = GTK_WIDGET(gtk_builder_get_object (builder, "label1")); 
